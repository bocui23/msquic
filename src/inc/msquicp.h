...
//    disable QUIC_BYPASS_CRYPTO/QUIC_ASYNC_CRYPTO/QUIC_BYPASS_HP, enable QUIC_BATCH_CRYPTO_HP
// Bypass all:
//    disable QUIC_ASYNC_CRYPTO, enable QUIC_BATCH_CRYPTO_HP/QUIC_BYPASS_CRYPTO/QUIC_BYPASS_HP
